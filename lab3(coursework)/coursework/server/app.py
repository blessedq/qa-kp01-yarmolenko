...
def binaryfile():
   if request.method == 'POST':
      ...
      file = binary_file(root, request.args.get('name'), request.args.get('info'))
      return jsonify({
...
def logtextfile():
   if request.method == 'POST':
      ...
      file = log_text_file(root, request.args.get('name'), request.args.get('info'))
      return jsonify({
         "message": "File created successfully.",
         "file": {
            "parent": str(file.parent.name),
...
def bufferfile():
   if request.method == 'POST':
      ...
      file = buffer_file(root, request.args.get('max_size'), request.args.get('name'))
      return jsonify({
         "message": "File created successfully.",
         "file": {
